...
export class VacationRequestComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.vacation = this.data.vacation.event.extendedProps.vacation;
    this.employee = this.data.vacation.event.extendedProps.vacation.employee;
    this.teamName = this.data.vacation.event.extendedProps.vacation.employee.teams;
    this.form = new FormGroup({
      startDate: new FormControl(
        this.data.vacation.event.start,
        Validators.required
      ),
      endDate: new FormControl(
        this.data.vacation.event.end,
        Validators.required
      )
    });
